  ...
  return (
    <Router>
      <Navbar expand="md" className={scrolled ? "scrolled" : ""}>
        <Container>
          <Navbar.Brand href="/">
            <h1 style={{color: "white", fontSize: "50px", fontWeight: 700, letterSpacing: "0.8px" }}>Portfolio</h1>
          </Navbar.Brand>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            ...
            <span className="navbar-text">
              ...
              <HashLink to='#connect'>
                <button className="vvd" style={{margin: "0 auto"}}><span>Let’s Connect</span></button>
              </HashLink>
            </span>
          </Navbar.Collapse>
        </Container>
